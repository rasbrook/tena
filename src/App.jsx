  ...
  return (
    <BrowserRouter>
      <Header
        ...
        rightCornerComponent={<div style={{ alignContent: 'center', alignItems: 'center' }}><input style={{ height: 20, backgroundColor: `${maincolor}55`, border: 'none', marginRight: 10, borderRadius: 20, padding: 10 }} /></div>}
        ...
        pages={user ? ['Dashboard', 'My-Course', "Profile"] : ['Dashboard']}
